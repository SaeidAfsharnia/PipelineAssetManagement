...
class Asset(object):
    ...
    def __getProjectBlock(self):
        ...
        self.project, self.block = xpdCore.getProjectBlock()
...
class AssetVersion(object):
    ...
    def getLods(self):
        lodList =  os.listdir(self.versionPath)
        lodModList = lodList[0:2]
        return lodModList
